...
import co.edu.konradlorenz.logistikapp.Fragments.RecuperarContrasenaFragment;
...
public class IniciarSesionActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(IniciarSesionActivity.this, android.R.layout.simple_dropdown_item_1line, emailAddressCollection);
    ...
    private void createListeners() {
        ...
        password_text_link.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment fragment = new RecuperarContrasenaFragment();
        ...
        sign_up_button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent newIntent = new Intent(IniciarSesionActivity.this, RegistrarActivity.class);
    ...
    private void logInSucceed() {
        ...
        for (UserInfo profile : user.getProviderData()) {
            newUser = new Usuario(user.getUid(),profile.getDisplayName(),profile.getEmail(),profile.getPhotoUrl().toString());
        }
        mDatabase.child("BaseDatos").child("Users").child(user.getUid()).setValue(newUser);
        Intent i = new Intent(IniciarSesionActivity.this, PrincipalActivity.class);
