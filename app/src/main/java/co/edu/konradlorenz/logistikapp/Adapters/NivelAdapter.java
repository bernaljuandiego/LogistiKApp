...
public class NivelAdapter extends RecyclerView.Adapter<NivelAdapter.ProductViewHolder>{

    private Context mCtx;
    private List<Nivel> productList;

    public NivelAdapter(Context mCtx, List<Nivel> productList) {
        this.mCtx = mCtx;
    ...
    public ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
       ...
       View view =inflater.inflate(R.layout.adapter_nivel,null);
    ...
    public void onBindViewHolder(ProductViewHolder holder, int position) {
        ...
        holder.botonStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(mCtx, UnityPlayerActivity.class);
